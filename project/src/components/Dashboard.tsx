...
import { Users, Calendar, TrendingUp, Settings, Plus, BookOpen, Lightbulb, Target, Star } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full p-4 text-left bg-gradient-to-r from-primary-50 to-accent-50 dark:from-primary-900/20 dark:to-accent-900/20 hover:from-primary-100 hover:to-accent-100 dark:hover:from-primary-900/30 dark:hover:to-accent-900/30 rounded-lg transition-colors duration-200 group border border-primary-200 dark:border-primary-700"
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-gradient-to-r from-primary-500 to-accent-500 rounded-lg flex items-center justify-center group-hover:scale-105 transition-transform duration-200">
                    <Target className="w-5 h-5 text-white" />
                  </div>
                  <div>
                    <h3 className="font-medium text-gray-900 dark:text-white">Smart Matches</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Find perfect skill exchange partners</p>
                  </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900 dark:text-white">Discover People</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Browse all skill profiles</p>
                  </div>
                </div>
              </button>
        ...
        <div className="mt-8 bg-gradient-to-r from-primary-600 to-accent-600 rounded-xl p-8 text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              onClick={() => onNavigate('matches')}
              className="px-6 py-3 bg-white text-primary-600 font-semibold rounded-lg hover:bg-gray-50 transition-colors duration-200 flex items-center gap-2"
            >
